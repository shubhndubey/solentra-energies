...
const BASE_TARIFF = 8; // ₹/unit, blended assumption for MP domestic tariff slabs
...
export function ratePerKw(kw) {
  switch (kw) {
    case 2:
      return 51000; // 2 × 51,000 = ₹1.02 lakh

    case 3:
      return 44000; // 3 × 44,000 = ₹1.32 lakh

    case 4:
      return 41250; // 4 × 41,250 = ₹1.65 lakh

    case 5:
      return 45400; // 5 × 45,400 = ₹2.27 lakh

    case 10:
      return 40000; // 10 × 40,000 = ₹4.00 lakh
